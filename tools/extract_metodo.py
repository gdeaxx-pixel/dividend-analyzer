...
def extraer(html: str) -> str:
    ...
    return f"""<!-- Derivado del demo del artifact en su ORIGEN, y mantenido a mano desde entonces.
     ...
     murió el contrato: el demo YA NO es su fuente. `tools/extract_metodo.py` quedó como
...
`ui/componentes/metodo.html`. Ese contrato murió cuando las fases 3.3a/3.3b cablearon el componente a datos
