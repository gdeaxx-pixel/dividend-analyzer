...
> **Pendiente de medir en local (ronda 2 de M4, 2026-09-25).** Ese PR (#149) suma **14 tests** y el #150
...
2026-09-25 sobre la rama `claude/credito-cobertura` fusionada con `main` tras el #149, que daba
1047: +6 tests del crédito con cobertura incompleta, R2-H2 de la ronda 2 de M4. El #149 había
sumado +14 sobre los 1033 de `e53bd97`, los que cierran los huecos de
