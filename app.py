...
with st.sidebar:
    ...
    st.sidebar.markdown(
        ...
        'color:#445566 !important;line-height:1.8 !important;text-transform:none !important;display:block;">'
        'Ingresa el costo de tu inversion tal como aparece en tu broker para cada ticker.<br><br>'
        'Escribe <b style="color:#1a1a1a !important;">solo el numero</b>, sin puntos ni comas. Si tiene decimales usa el <b style="color:#1a1a1a !important;">punto (.)</b><br>'
